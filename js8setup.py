    ...
    if gv.project_dir == "None":
        ...
        if sysPlatform == "Linux":
            ...
            with open(desktop_launcher_path, "w") as fh:
                fh.writeline("[Desktop Entry]")
                fh.writeline("Version=1.0")
                fh.writeline("Type=Application")
                fh.writeline("Terminal=false")
                fh.writeline("Icon="+icon_picture_path)
                fh.writeline("Icon[en_US]="+icon_picture_path)
                fh.writeline("Name[en_US]=JS8msg")
                fh.writeline("Exec="+exec_path)
                fh.writeline("Comment[en_US]=EMCOMM message support for JS8call")
                fh.writeline("Name=JS8msg")
                fh.writeline("Comment=EMCOMM message support for JS8call")
